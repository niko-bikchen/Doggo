...
const Registration = () => {
  ...
  return (
    <div>
      <NextSeo
        canonical="https://doggo.co.ua/registration"
        title="Doggo | Реєстрація"
      ...
      <div className={styles["Registration"]}>
        ...
        <Card classes={{ root: classes.card }} elevation={10}>
          <Box
            textAlign="center"
            style={{ display: showStepper ? "none" : "block" }}
          >
            <Typography variant="h5" component="h1">Ваша роль?</Typography>
          </Box>
          <CardContent>
            <Grid container>
              <Grid
              ...
              <Grid
                item
                xs={12}
                style={{ display: showStepper ? "block" : "none" }}
              >
                {userRole === "dogwalker" ? (
                  <DogwalkerStepper revertRole={initStepper(false)} />
                ) : null}
              </Grid>
            </Grid>
          </CardContent>
