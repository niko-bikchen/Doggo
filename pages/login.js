                    ...
                    <CardContent>
                        <form autoComplete="off">
                            <Grid container spacing={5} justify="center">
                                <Grid item xs={12}>
                                    <DoggoInput onChange={onInputChange} helperText={!credentialsValidated.email && "Пошта не відповідає стандартному формату"} error={!credentialsValidated.email} name="email" fullWidth variant="outlined" label="Пошта" type="text" InputProps={{ startAdornment: (<InputAdornment position="start"><MailOutlineIcon /></InputAdornment>) }} />
                                </Grid>
                                <Grid item xs={12}>
                                    <DoggoInput onChange={onInputChange} helperText={!credentialsValidated.password && "Поле не має бути порожнім"} error={!credentialsValidated.password} onChange={onInputChange} name="password" fullWidth variant="outlined" label="Пароль" type="password" InputProps={{ startAdornment: (<InputAdornment position="start"><LockOutlinedIcon /></InputAdornment>) }} />
                                </Grid>
                            </Grid>
                        </form>
