...
const Login = ({ setJwt }) => {
  ...
  return (
    <div>
      <NextSeo
        canonical="https://doggo.co.ua/login"
        title="Doggo | Авторизация"
        description="Авторизуватись на сайті."
      />
          ...
          <Grid container>
            <Grid item xs={12} md={6}>
              <Box className={classes.root} textAlign="right" mr={2}>
                <Typography variant="h5" component="h1">Вхід</Typography>
              </Box>
            </Grid>
              ...
              <Grid container spacing={5} justify="center">
                <Grid item xs={12}>
                  <DoggoInput
                    ...
                    helperText={
                      !credentialsValidated.email &&
                      "Пошта не відповідає стандартному формату"
                    }
                    error={!credentialsValidated.email}
                    name="email"
                    fullWidth
                    variant="outlined"
                    label="Пошта"
                ...
                <Grid item xs={12}>
                  <DoggoInput
                    ...
                    error={!credentialsValidated.password}
                    onChange={onInputChange}
                    name="password"
                    fullWidth
                    variant="outlined"
